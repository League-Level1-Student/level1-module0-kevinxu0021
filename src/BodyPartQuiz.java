	...
	private void startQuiz() {
		...
		for (int i = 0; i < 4; i++) {
			...
			if (i == 0 && guess.equalsIgnoreCase("arnold")) {
				...
				if (i == 0) {
					JOptionPane.showMessageDialog(null, "You got it wrong. The person is Arnold.");
				} else if (i == 1) {
					JOptionPane.showMessageDialog(null, "You got it wrong. The person is Leonardo.");
				} else if (i == 2) {
					JOptionPane.showMessageDialog(null, "You got it wrong. The person is Morgan.");
				} else if (i == 3) {
					JOptionPane.showMessageDialog(null, "You got it wrong. The person is Jack.");
				}
			}
